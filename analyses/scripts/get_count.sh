#!/bin/bash
#
# Helper to count the numbber of events passing a condition
#
# Usage:
#   get_count.sh "ntuple_file" "optional_condition_list"

function usage {
    echo "Usage:"
    echo "  get_count.sh \"ntuple_file\" \"optional_condition_list\""
    exit
}
