...
set label 102 '{/*0.8 Pythia8(M13), anti-k_t(0.8 or 1)}' right at graph 0.97,0.05
set label 103 sprintf('{/*0.8 %g<m<%g GeV}',mmin,mmax)   right at graph 0.97,0.10
...
merge(pt)="< bash -c \" cat <( grep -v '^#' ../quality-measures/qualities-R0.8.new | sed 's/^/R0.8-/g') <( grep -v '^#' ../quality-measures/qualities-R1.0.new | sed 's/^/R1.0-/g') \" "

mtruth(pt)=merge(pt).' | awk "{if (\$2=='.pt.'){print \$1,\$9,\$10,\$11}}"  | ../quality-measures/optimal-line-new'
mpu50 (pt)=merge(pt).' | awk "{if (\$2=='.pt.'){print \$1,\$12,\$13,\$14}}" | ../quality-measures/optimal-line-new'
matlas(pt)=merge(pt).' | awk "{if (\$2=='.pt.'){print \$1,\$15,\$16,\$17}}" | ../quality-measures/optimal-line-new'
mcms  (pt)=merge(pt).' | awk "{if (\$2=='.pt.'){print \$1,\$18,\$19,\$20}}" | ../quality-measures/optimal-line-new'
...
do for [pt in "500 1000 2000"]{
    ...
    plot mtruth(pt) i 0 u 2:3 w p pt 7 ps 0.5 lc 1 t 'all',\
         ...
         mtruth(pt).' | grep "^R0.8-N2_beta1_ttt"'  u 2:3 w p pt  5 ps 1.2 lc rgb "#00cc00" t 'CMS-like',\
...
#          mpu50(pt).' | grep "^R0.8-N2_beta1_ttt"'  u 2:3 w p pt  5 ps 1.2 lc rgb "#00cc00" t 'CMS-like',\
...
#          matlas(pt).' | grep "^R0.8-N2_beta1_ttt"'  u 2:3 w p pt  5 ps 1.2 lc rgb "#00cc00" t 'CMS-like',\
...
#          mcms(pt).' | grep "^R0.8-N2_beta1_ttt"'  u 2:3 w p pt  5 ps 1.2 lc rgb "#00cc00" t 'CMS-like',\
