...
\subsection{Techniques (Obs)}

\subsection{Techniques (groom)}

\subsection{Techniques (pileup)}
...
\subsection{What is robustness?  (ROC curve, or distribution)}
