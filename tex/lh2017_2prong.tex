...
\begin{figure}
  \centering{\includegraphics[width=0.5\textwidth]{figures/mass-distribs.pdf}}
  %
...
\begin{figure}
  \centering{\includegraphics[width=0.5\textwidth]{figures/rocs.pdf}}
  %
...
In \Fig{fig:grooming-hadronisation} we show $D_2$, $N_2$ and dichoic $D_2$ for the different grooming strategies.
In \Fig{fig:shapes-hadronisation} we consider fixed grooming strategies in each plot, but different jet shape observables.
...
\begin{figure}
  ...
  %
  \caption{Performance-Resilience plot for truth to hadron comparing different grooming stratgies}\label{fig:grooming-UE}
\end{figure}
...
\begin{figure}
  ...
  %
  \caption{Performance-Resilience plot truth to hadron different observables. }\label{fig:shapes-UE}
\end{figure}
...
The respective model configurations are A (\emph{ATLAS-like} \cite{PERF-2007-01}) and C (\emph{CMS-like} \cite{CMS-TDR-08-001}).
...
In this paper, we have performed a comprehensive study of performance and robustness for two-prong tagging, and provided a unifying approach to understanding different classes of two-prong taggers. 

We have introduced measures of robustness, in addition to the standard measures of performance. We used these measures to study the resilience of two-prong taggers to theory issues, namely hadronization and underlying event. 

 We believe that these will be of more general utility in jet substructure, and could be applied also to study $3$-prong tagging, for example.

We have also introduced a number of new dichroic observables, which generalize the dichroic $N$-subjettiness observable. This offers a general and unifying approach to designing new jet substructure observables which are simultaneously performant and resilient

We have also studied the effect of polarization on two-prong taggers. We proposed the observable $z_g$ as an effective polarization tagger.
