...
pile-up contaminsation, one uses a variety of pile-up mitigation
...
subtracting pileup from jet shapes). More recently, more complex
pileup subtraction methods have been
...
simply motivated by its speed --- for a typical LHC event with pileup
would be subtracted and clustered in 200-700~$\mu$s.
%
