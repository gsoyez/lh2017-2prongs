...
\section{PERFORMANCE VERSUS ROBUSTNESS:  \\ TWO-PRONG SUBSTRUCTURE TAGGERS FOR THE LHC \protect\footnote{Section coordinators:  P.~Loch, I.~Moult, B.~Nachman, G.~Soyez, J.~Thaler}$^{,}$~\protect\footnote{Contributing authors: D.~Bhatia, R.~Camacho, G.~Chachamis, S.~Chatterjee, F.~Dreyer, D.~Kar, A.~Papaefstathiou, T.~Samui, A.~Siodmok}}
